'''This module tests message unpin'''
import pytest
...
def test_valid():
    ...
    message_unpin(user_a['token'], message_id)
...
def test_invalid_token():
    ...
    with pytest.raises(AccessError):
        message_unpin("invalid_token", message_id)
...
def test_not_in_channel():
    ...
    with pytest.raises(AccessError):
        message_unpin(user_b['token'], message_id)
